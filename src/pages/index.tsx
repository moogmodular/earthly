            ...
            {isWide ? (
              <div className="flex w-1/2 flex-col gap-2 p-4 lg:w-1/2 lg:overflow-y-scroll">
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    This website is in early alpha. The events you create are
                    sent to <b>wss://relay.earthly.land</b> and can be nuked at
                    any time-. If the relay is down the relays can be pulled
                    from your metadata and be visible to the public.{" "}
              ...
              <Sheet>
                ...
                <SheetContent
                  className="h-2/3 w-[2/3] sm:w-full"
                  side={"bottom"}
                >
                  <SheetHeader>
                    <SheetDescription className={"flex flex-col"}>
                      <Alert variant="destructive">
                        ...
                        <AlertDescription>
                          ...
                          nuked at any time-. If the relay is down the relays
                          can be pulled from your metadata and be visible to the
                          public.{" "}
                          <b>Please do not use this for anything sensitive.</b>{" "}
                          <b className={"italic underline"}>
                            However feel free to draw something interesting.
